...
ALTER TABLE "barter" ADD CONSTRAINT "barter_fk1" FOREIGN KEY ("user_id") REFERENCES "user"("id");
...
ALTER TABLE "message" ADD CONSTRAINT "message_fk1" FOREIGN KEY ("user_sender_id") REFERENCES "user"("id");

ALTER TABLE "message" ADD CONSTRAINT "message_fk2" FOREIGN KEY ("user_recipient_id") REFERENCES "user"("id");
