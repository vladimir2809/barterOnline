...
app.post('/querySearch/', function(req, res){
    ...
    //console.log (data.nameGive, data.nameGet, data.categoryGive,data.categoryGet ,data.freeGet, data.barter_id )
    countSearchQuery++;
...
const getLine = () => {
  ...
  // stack[1] - это обычно место вызова функции getLine
  return stack[2]; 
};
////console.log(getLine()); // Выведет строку с файлом и номером
/*
